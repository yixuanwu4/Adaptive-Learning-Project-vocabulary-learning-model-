# To successfully compile the script
# Please change the path of the target file according to its location on your pc
...
with open("/home/nauxiy/Workspace/Adaptive learning/Term project + paper/data/some test files/CET6_edited1.txt", "r") as fp:
    lines = fp.readlines()
...
new_file = open("/home/nauxiy/Workspace/Adaptive learning/Term project + paper/data/some test files/CET6_edited1.txt", "w+")
for line in lines:
    new_file.write(line)
new_file.close()